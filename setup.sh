...
sed -i 's/<string>USB port limit patch #1 10.14.x modify by DalianSky(credit ydeng)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER1/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #1 10.14.x modify by DalianSky(credit ydeng)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER2/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #1 10.14.x modify by DalianSky(credit ydeng)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER3/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #1 10.14.x modify by DalianSky(credit ydeng)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER4/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #2 10.14.x modify by DalianSky(credit PMHeart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER1/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #2 10.14.x modify by DalianSky(credit PMHeart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER2/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #2 10.14.x modify by DalianSky(credit PMHeart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER3/EFI/CLOVER/config.plist"
sed -i 's/<string>USB port limit patch #2 10.14.x modify by DalianSky(credit PMHeart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER4/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #3 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #3<\/string>/g' "Clover.Folder/$USER1/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #3 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #3<\/string>/g' "Clover.Folder/$USER2/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #3 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #3<\/string>/g' "Clover.Folder/$USER3/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #3 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #3<\/string>/g' "Clover.Folder/$USER4/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #4 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #4<\/string>/g' "Clover.Folder/$USER1/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #4 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #4<\/string>/g' "Clover.Folder/$USER2/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #4 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #4<\/string>/g' "Clover.Folder/$USER3/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #4 10.14.x modify by DalianSky(credits PMheart)<\/string>/<string>USB Port Limit Patch #4<\/string>/g' "Clover.Folder/$USER4/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #1(credits PMheart)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER1/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #1(credits PMheart)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER2/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #1(credits PMheart)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER3/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #1(credits PMheart)<\/string>/<string>USB Port Limit Patch #1<\/string>/g' "Clover.Folder/$USER4/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #2(credits PMheart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER1/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #2(credits PMheart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER2/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #2(credits PMheart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER3/EFI/CLOVER/config.plist"
sed -i 's/<string>USB Port limit patch #2(credits PMheart)<\/string>/<string>USB Port Limit Patch #2<\/string>/g' "Clover.Folder/$USER4/EFI/CLOVER/config.plist"
